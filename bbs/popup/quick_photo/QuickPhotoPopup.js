    ...
    function html5Upload() {
    	...
    	sUploadURL= 'http://www.smedics.co.kr/bbs/popup/quick_photo/FileUploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://www.smedics.co.kr/bbs/popup/quick_photo/FileUploader.php',
