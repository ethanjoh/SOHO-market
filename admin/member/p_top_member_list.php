              ...
              <div class="col-sm-12">
                <section class="panel">
                  ...
                  <ul class="info-body">
                    ...
                    <li><i class="fa fa-info-circle"></i> 회원 할인율 변경 전에 회원이 카트에 담아둔 상품이 있다면 모두 삭제하도록 합니다. 기존에 담아둔 상품들은 변경 할인율이 적용되지 않습니다. </li>
                  </ul>
                </section>
              </div>
            </div>
...
//회원 테이블의 리스트를 불러옵니다.
$query  = "SELECT * FROM p_member WHERE 1 $search_keyword ORDER BY seq_num";
...
$sql_2    = "SELECT * FROM p_member WHERE 1 $search_keyword ORDER BY seq_num DESC LIMIT $cline,$scale1 ";
