		...
		?></td>
              ...
              <tr class="odd">
                ...
                <td class="member"><select name="hphone1" />
                  ...
                  <option value="010" <? if($hphone[0] =='010') echo"selected"; ?> >010</option>
                  <option value="011" <? if($hphone[0] =='011') echo"selected"; ?> >011</option>
                  <option value="016" <? if($hphone[0] =='016') echo"selected"; ?>>016</option>
                  <option value="017" <? if($hphone[0] =='017') echo"selected"; ?>>017</option>
                  <option value="018" <? if($hphone[0] =='018') echo"selected"; ?>>018</option>
                  <option value="019" <? if($hphone[0] =='019') echo"selected"; ?>>019</option>
                  </select>
                  -
