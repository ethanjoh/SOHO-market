...
?>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <!-- <input type="text" class="form-control" name="o_zipcode2" id="o_zipcode2" size="3"  value="<?php echo $o_zipno[1]; ?>" readonly /> -->
...
?>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <?php echo $rows['homepage'] ? "&nbsp;&nbsp;<a href=\"http://$rows[homepage]\" target=\"_blank\"><img src=\"../images/browser_explorer.png\" alt=\"홈페이지 가기\" /></a>" : ""; ?>
                            </td>
                          </tr>
                          <tr>
                            <th colspan="2">배송지 정보
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <!-- <input type="text" class="form-control" name="d_zipcode2" id="d_zipcode2" size="3"   value="<?php echo $d_zipno[1]; ?>" readonly /> -->
...
?>
                    ...
                    <div class="row text-center">
                      <div class="col-sm-12">
                        ...
                        <?php echo ($from == "mail") ? "<a type=\"button\" class=\"btn btn-default\" href=\"#\" onclick=\"opener.location.replace('mem_sendmail_list.php');window.close();\">닫기</a>" : "<a type=\"button\" class=\"btn btn-default\" href=\"#\" onclick=\"opener.location.replace('top_member_list.php?page=$page');window.close();\">닫기</a>"; ?>
                      </div>
                    </div>
                  </form>
                  </div>
