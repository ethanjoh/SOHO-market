      <form method="post" name="mail" action="inc/sendmail_each_ok.php" enctype="multipart/form-data">
        ...
        <table summary="buttons">
          <tbody>
            <tr>
              <td><div class="clear"><a class="button" href="#" onclick="this.blur();javascript:send_mail();"><span>메일 보내기</span></a><a class="button" href="#" onclick="this.blur();javascript:document.mail.reset();"><span>다시 작성</span></a></div></td>
            </tr>
          </tbody>
        </table>
      </form>
