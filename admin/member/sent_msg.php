...
<div id="wrapper">
  ...
  <div id="bodyblock">
	...
	$query = "SELECT mnum FROM message_info
	          WHERE sendid_fk = 'admin' AND send_del = 'N' ";
	...
	mysqli_free_result($result);
	 ...
	 if ($limit >= $total_bnum) 
	  ...
	  $query2 = "SELECT * FROM message_info msg, member m
	             WHERE msg.sendid_fk = 'admin' AND msg.send_del = 'N' AND m.id = msg.receiveid_fk
		  	       ORDER BY msg.mnum DESC LIMIT $cline,$p_scale1";
