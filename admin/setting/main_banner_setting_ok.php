    ...
    if (isset($_FILES['uploadfile'])) {
        for ($i = 0; $i < count($_FILES['uploadfile']['name']); $i++) {
            ...
            if ($result) {
                ...
                // 배치합니다.
                $move_to = $dir . '/main_' . time() . $i . '_' . md5(microtime() . $name . $_SERVER['REMOTE_ADDR']) . '.' . $ext;
        ...
        $qry = "INSERT INTO main_banner(  m_banner1,  m_banner1_image, m_link1,
                                      ...
                                      created)
              VALUES( '$mimg_chk[0]', '$file[0]', '$mlink[0]',
