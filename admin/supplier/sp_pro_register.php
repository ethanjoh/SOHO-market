      ...
      <form name="form1" method="post" enctype="multipart/form-data" action="sp_pro_register_ok.php">
        ...
        <table summary="register product">
          ...
          <tr class="odd">
            ...
            <td class="member"><input type="radio" name="del_chk" value="N" <?php if(($mode=='insert') || ($update_row['del_chk']=='N')) echo("checked"); ?>/>
              등록
              <input type="radio" name="del_chk" value="Y" <?php if($update_row['del_chk']=='Y') echo("checked"); ?> />
              판매중지(숨김)
              <input type="radio" name="del_chk" value="O" <?php if($update_row['del_chk']=='O') echo("checked"); ?> />
		  ...
		  <?php if($update_row['main_new']=='Y') echo"checked"; ?> />
              신상품
              <input type="checkbox" name="main_special"  
		  <?php if($update_row['main_special']=='Y') echo"checked"; ?> />
              기획상품
              <input type="checkbox" name="main_best"  
		  <?php if($update_row['main_best']=='Y') echo"checked"; ?> />
              인기상품</td>
          </tr>
          <tr class="odd">
            <th class="column1" scope="row">아이콘 표시</th>
            <td class="member"><input type="checkbox" name="option1_chk"  
		  <?php if($update_row['option1_chk']=='Y') echo"checked"; ?> />
              <img src="../images/New_icons_44.gif" alt="신상품" width="28" height="11" />
              <input type="checkbox" name="option2_chk"  
		  <?php if($update_row['option2_chk']=='Y') echo"checked"; ?> onclick="javascript:alert('아래 항목에서 해당 내용을 설정 또는 해제하세요.');" />
              <img src="../images/event_icon.gif" alt="기획상품" width="43" height="16" />
              <input type="checkbox" name="option3_chk"  
		  <?php if($update_row['option3_chk']=='Y') echo"checked"; ?> />
              <img src="../images/best_icon.gif" alt="인기상품" width="43" height="16" />
              <input type="checkbox" name="option4_chk"  
		  <?php if($update_row['option4_chk']=='Y') echo"checked"; ?> onclick="javascript:alert('아래 항목에서 해당 내용을 설정 또는 해제하세요.');" />
              <img src="../images/sale_icon.gif" alt="할인상품" width="43" height="16" />
              <input type="checkbox" name="option5_chk"  
		  <?php if($update_row['option5_chk']=='Y') echo"checked"; ?> />
              <img src="../images/delivery_icon.gif" alt="당사직송" width="43" height="16" /></td>
          </tr>
          <tr>
            <th rowspan="2" class="column1" scope="row">이벤트 신청</th>
            <td class="member"><input type="radio" name="event" value="0" <? if(($mode=='insert') || ($update_row['event']=='0')) echo("checked"); ?> />
              해당사항 없음(중지)
              <input type="radio" name="event" value="1" <? if($update_row['event']=='1') echo("checked"); ?>/>
              할인판매
              <input type="radio" name="event" value="2" <? if($update_row['event']=='2') echo("checked"); ?>/>
              사은품 증정
              <input type="radio" name="event" value="3" <? if($update_row['event']=='3') echo("checked"); ?>/>
              할인+사은품 증정
              <input type="radio" name="event" value="4" <? if($update_row['event']=='4') echo("checked"); ?>/>
              1+1 </td>
          </tr>
          <tr>
            <td class="member">기간 :
...
?>
          ...
          <tr >
            ...
            <td class="member"><input type="file" name="b_image1" size="30" />
              (400x400)
              <?php if($update_row['b_image1']) echo "<img src=\"$update_row[b_image1_name]\" width=\"50\" height=\"50\" onerror=\"this.src='../images/no_image50.gif'\"/>"; ?></td>
          </tr>
          <tr class="odd">
            <th scope="row" class="column1">상품이미지 2(대:확대)</th>
            <td class="member"><input type="file" name="b_image2" size="30" />
              (400x400)
              <?php if($update_row['b_image2']) echo "<img src=\"$update_row[b_image2_name]\" width=\"50\" height=\"50\" onerror=\"this.src='../images/no_image50.gif'\"/>"; ?></td>
          </tr>
          <tr >
            <th scope="row" class="column1">상품이미지 3(대:확대)</th>
            <td class="member"><input type="file" name="b_image3" size="30" />
              (400x400)
              <?php if($update_row['b_image3']) echo "<img src=\"$update_row[b_image3_name]\" width=\"50\" height=\"50\" onerror=\"this.src='../images/no_image50.gif'\"/>"; ?></td>
          </tr>
          <tr class="odd">
            <th scope="row" class="column1">상품이미지 4(대:확대)</th>
            <td class="member"><input type="file" name="b_image4" size="30" />
              (400x400)
              <?php if($update_row['b_image4']) echo "<img src=\"$update_row[b_image4_name]\" width=\"50\" height=\"50\" onerror=\"this.src='../images/no_image50.gif'\"/>"; ?></td>
          </tr>
          <tr >
            <th scope="row" class="column1">상품이미지 5(대:확대)</th>
            <td class="member"><input type="file" name="b_image5" size="30" />
              (400x400)
              <?php if($update_row['b_image5']) echo "<img src=\"$update_row[b_image5_name]\" width=\"50\" height=\"50\" onerror=\"this.src='../images/no_image50.gif'\"/>"; ?></td>
          </tr>
          <tr class="odd">
