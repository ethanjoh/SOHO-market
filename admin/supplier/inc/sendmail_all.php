...
?>
 ...
 ?>
              <td><?=$bunho?></td>
              <td><a href="javascript:open_win('view_member.php?num=<?=$list['seq_num']?>','nwin','scrollbars=yes,resizable=yes, width=650,height=650');">
                <?=$list['id']?>
                </a></td>
  ...
  ?>
        ...
        <table summary="send mail">
          <tbody>
            <tr>
              <td width="20%"><div class="full"><a class="button" href="javascript:mail_send()" onclick="this.blur();"><span>메일 보내기</span></a></div></td>
              <td width="45%"><?php
