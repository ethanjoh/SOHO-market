...
if ($from == 'basket' && $mode == 'del') {
    ...
    $query = "INSERT INTO offer_cart (user_id, user_sid, product_code,volume, amount, p_opt, barcode, wdate  )
				VALUES ('$id',
						'$_COOKIE[p_sid]',
						'$pnum',
						'$products_count',
    ...
    if ($result) {
        ...
        //장바구니에 담긴 수량 확인
        $query1  = "SELECT sum(volume) AS cnt FROM products p, offer_cart c WHERE c.user_id='$id' AND p.num=c.product_code ORDER BY c.cart_id DESC ";
