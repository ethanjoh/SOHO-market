...
var floatingMenu = {
    ...
    hasElement: typeof(document.documentElement) == 'object' && typeof(document.documentElement.clientWidth) == 'number'
};
...
floatingMenu.add = function(obj, options) {
    ...
    if (options == undefined) {
        ...
        floatingArray.push({
            ...
            updateParentHeight: options.updateParentHeight == undefined ? false : options.updateParentHeight,
            ...
            confinementAreaId: options.confinementArea != undefined && options.confinementArea.substring(0, 1) == '#' ? options.confinementArea.substring(1) : undefined,

            confinementAreaClassRegexp: options.confinementArea != undefined && options.confinementArea.substring(0, 1) == '.' ? new RegExp("(^|\\s)" + options.confinementArea.substring(1) + "(\\s|$)") : undefined
        });
    }
};
...
floatingMenu.scrollLeft = function(item) {
    ...
    return this.hasInner ? w.pageXOffset : this.hasElement ? w.document.documentElement.scrollLeft : w.document.body.scrollLeft;
};
...
floatingMenu.scrollTop = function(item) {
    ...
    return this.hasInner ? w.pageYOffset : this.hasElement ? w.document.documentElement.scrollTop : w.document.body.scrollTop;
};
...
floatingMenu.isConfinementArea = function(item, area) {
    return item.confinementAreaId != undefined && area.id == item.confinementAreaId || item.confinementAreaClassRegexp != undefined && area.className && item.confinementAreaClassRegexp.test(area.className);
};
...
floatingMenu.insertEvent = function(element, event, handler) {
    ...
    element[listener] = function(e) {
        ...
        return (oldHandler != undefined) && (oldHandler(e) == true) && (result == true);
    };
};
