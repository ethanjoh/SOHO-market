            ...
            <div class="row">
              <div class="col-sm-12">
                <section class="panel">
                  ...
                  <ul class="info-body">
                    <li><i class="fa fa-info-circle"></i> 하단의 브랜드 등록하기를 통해 등록하세요.</li>
                    <li><i class="fa fa-info-circle"></i> 브랜드 등록 후 중분류 등록은 해당 브랜드명을 클릭하세요.</li>
                    <li><i class="fa fa-info-circle"></i> 등록 후에도 수정이 가능합니다.</li>
                    <li><i class="fa fa-info-circle"></i> 메인메뉴에서 감추려면 '숨김'을 누르세요.</li>
                    <li><i class="fa fa-info-circle"></i> <i class="fa fa-external-link"></i>를 클릭하면 새 창에서 해당 브랜드가 열립니다.</li>
                  </ul>
                </section>
              </div>
            </div>
...
?>
            ...
            <div class="row text-center">
              <div class="col-sm-12">
                <a type="button" class="btn btn-success" href="ca_register.php">브랜드 등록하기</a>
              </div>
            </div>
            <!-- buttons end -->
