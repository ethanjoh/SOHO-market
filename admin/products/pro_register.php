...
<!-- 													<tr>
    												...
    												<tr>
    													<th><img src="../images/icn_05.gif" width="24" height="14" alt="선택" /> 옵션 / 재고</th>
    													<td>
<?php
    ...
    if (isset($update_row['opt'])) {
        ...
        echo <<<HEREDOC
                                                            ...
                                                            <input name="opt_name_ins" type="text" class="form-control" value="" size="100" >
															<p class="help-block"><i class="fa fa-exclamation-triangle"></i> 구분은 ',(콤마)'로 하세요 (예:블루,레드,블랙)</p>
                                							<p class="help-block"><i class="fa fa-exclamation-triangle"></i> 옵션명 중간에 ',(콤마)'가 들어가지 않도록 유의하세요</p>
                                                            <input name="opt_count_ins" type="text" class="form-control" value="" size="100" >
    														<p class="help-block"><i class="fa fa-exclamation-triangle"></i> 재고구분은 ',(콤마)'로 하세요 (예:100,100,100)</p>
HEREDOC;
    }
...
<!--     												<tr>
    													...
    													<td>
    														<input name="stock_ins" type="text" class="form-control" value="" size="5" > 개
															<p class="help-block"><i class="fa fa-exclamation-triangle"></i> 옵션이 없을 경우 전체 재고를 입력하세요</p>
															<p class="help-block"><i class="fa fa-exclamation-triangle"></i> 재고를 입력하지 않으면 표시되지 않습니다</p>
    													</td>
    												</tr> -->
            										<tr>
            											<th colspan="2">
...
<!--     												<tr>
    													<th><img src="../images/icn_05.gif" width="24" height="14" alt="선택" /> 전체 재고</th>
    													<td>
    														<input name="stock" type="text" class="form-control" value="" size="5" > 개
															<p class="help-block"><i class="fa fa-exclamation-triangle"></i> 옵션이 없을 경우 전체 재고를 입력하세요</p>
															<p class="help-block"><i class="fa fa-exclamation-triangle"></i> 재고를 입력하지 않으면 표시되지 않습니다</p>
    													</td>
    												</tr> -->
