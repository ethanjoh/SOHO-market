...
<div id="command_bar">
  <div align="center">A4용지를 준비하고 인쇄방향을 가로로 설정하세요. &nbsp; 
    <input type="button" value="인쇄하기" onClick="printNow()" /> 
    <input type="button" value="닫기" onClick="window.close()" />
  </div>
</div>
<table width="460" border="0" cellspacing="0" cellpadding="0" align="center" style="table-layout:auto">
  <tr>
<?php for ($copy_=1; $copy_<=2; $copy_++) { ?>
        ...
        <tr> 
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="border_in" style="border-top-style:none;border-left-style:none">
              <tr height="20"> 
                ...
                <td class="tl_dot" style="border-top-style:none" align="center">옵 션</td>
  ...
  <?php for ($i=0, $maxi=count($prtArticle); $i<$maxi; $i++) { ?>
              <tr height="20">
                ...
                <td class="lb_dot" style="border-top-style:none" align="left"><?=$prtArticle[$i]['article']?></td>
