...
<html>
  ...
  <body>
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td>
          <table width="600" border="1" cellpadding="0" cellspacing="0" bordercolor="#3399FF">
            <tr>
...
?>
                ...
                <td colspan="6"><table width="100%" height="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#3399FF">
                  ...
                  <tr>
                    ...
                    <td width="100"><div align="center"><font size="1"><?php echo $row['company_name']; ?></font></div></td>
                    ...
                    <td width="174">
                      <div style="position: relative; background: url(../images/sign/stamp.gif) no-repeat; background-position: 20px 0px; height: 60px; width: auto;">
                        <div style="position: absolute; bottom: 25px; margin:auto;"><font size="1"><?php echo $row['ceo']; ?> (인)</font></div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><div align="center"><font size="1"><?php echo $row['category2']; ?></font></div></td>
                  </tr>
                </table></td>
                </tr>
                <tr>
