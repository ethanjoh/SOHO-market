...
if($mode == 'm1'){
  ...
  //echo "<meta http-equiv='refresh' content='0; URL=m_or_view.php?mode=$mode&oid=$oid&page=$page'>";
  /*
  echo "<script>\n";
  echo "     document.location.replace(\"m_or_view.php?mode=$mode&oid=$oid&page=$page\");\n";
  echo "</script>\n";
  */
...
//발송완료
if($mode== '3' || $mode == '4' || $mode == 'a'){ // 3: 주문내역, 4: 사입, a:전체송장번호입력에서
