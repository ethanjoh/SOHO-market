...
## [v1.4.0] - 최근 업데이트 (결제 안정성 및 재고 정합성 강화, 보안 리팩토링)
...
## [v1.1.0] (PG 결제 연동 및 데이터 관리 시스템 구축)
