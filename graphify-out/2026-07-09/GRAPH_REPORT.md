# Graph Report - SOHO-market  (2026-07-09)

## Corpus Check
- 1248 files · ~4,242,783 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8150 nodes · 13798 edges · 1297 communities (1066 shown, 231 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1987 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1bf7b776`
...
- PHPExcel Formula Functions
- PHPExcel Formula Functions
- PHPExcel DateTime Calculations
- CodeMirror Code Editors
- PHPExcel Worksheet Management
- jQuery Plugin Collection
- PHPExcel Excel5 Writers
- EmmaSMS Gateway Integration
- PHPExcel Core Libraries
- CodeMirror Code Editors
- Member Php Php Mailer Changelog Compo...
...
- CKEditor Rich Text Editors
- PHPExcel Engineering Calculations
- CKEditor Rich Text Editors
- Highcharts Data Visualizations
- PHPExcel Worksheet Management
- PHPExcel File Readers
...
- PHPExcel Worksheet Management
- PHPExcel Excel5 Writers
- Member Php Php Mailer Class Smtp Comp...
- PHPExcel Core Libraries
- Admin Portal Functions
- Admin Portal Functions
- jQuery Plugin Collection
...
- PHPExcel Core Libraries
- CKEditor Rich Text Editors
- PHPExcel Database Calculations
- PHPExcel File Readers
- PHPExcel Worksheet Management
- PHPExcel Worksheet Management
- PHPExcel Core Libraries
...
- Admin Portal Functions
- CKEditor Rich Text Editors
- Member Php Php Mailer Composer Compon...
- CodeMirror Code Editors
- PHPExcel Core Libraries
- PHPExcel Core Libraries
- PHPExcel Core Libraries
...
- Js Vendor Jquery Min Components
- Admin Portal Functions
- CodeMirror Code Editors
- PHPExcel Core Libraries
- PHPExcel Core Libraries
...
- Admin Portal Functions
- Admin Portal Functions
- Member Php Php Mailer Extras Htmlfilt...
- jQuery Plugin Collection
...
- PHPExcel Excel5 Writers
- Admin Portal Functions
- Member Php Php Mailer Extras Easypeas...
- Member Php Php Mailer Extras Ntlm Sas...
- Admin Portal Functions
- Admin Portal Functions
- PHPExcel Core Libraries
- PHPExcel Core Libraries
...
- Admin Portal Functions
- CKEditor Rich Text Editors
- Web JS Ui Jquery Ui Widget Components
- BBS Boards & Forums
- Product Category Admin
- Product Category Admin
- Product Category Admin
...
1. `PHPExcel_Calculation_Functions` - 284 edges
2. `PHPExcel_Worksheet` - 151 edges
3. `PHPMailer` - 105 edges
4. `PHPExcel_Calculation_Statistical` - 98 edges
5. `PHPExcel_Shared_String` - 71 edges
6. `PHPExcel_Writer_Excel5_Worksheet` - 71 edges
7. `e()` - 69 edges
8. `PHPExcel` - 64 edges
9. `PHPExcel_Calculation` - 62 edges
10. `PHPMailerTest` - 60 edges
...
## Communities (1297 total, 231 thin omitted)
...
Cohesion: 0.04
Nodes (3): PHPExcel_Calculation_DateTime, PHPExcel_Calculation_Financial, PHPExcel_Shared_Date
...
Cohesion: 0.06
Nodes (48): Ac(), Ad(), af(), Bb(), Bc(), Bd(), Bf(), Ca() (+40 more)
...
Cohesion: 0.09
Nodes (44): cdata(), clean(), colorLines(), coverage(), create(), Doc(), error(), errorDiff() (+36 more)

### Community 20 - "PHPExcel Excel2007 Writers"
Cohesion: 0.04
...
Cohesion: 0.09
Nodes (21): CHANGELOG, [v1.0.0] - 2016-01-19 ~ 2016-02-18 (초기 빌드 및 기본 커머스 아키텍처 수립), [v1.1.0] - 2016-02-18 ~ 2016-03-05 (PG 결제 연동 및 데이터 관리 시스템 구축), [v1.2.0] - 2016-03-05 ~ 2016-04-30 (개인 회원 체계 및 메일링 시스템 도입), [v1.3.0] - 2016-05-02 ~ 2016-07-22 (모바일 결제 확장 및 배송 시스템 세분화), [v1.4.0] - 2016-09-22 ~ 2026-07-09 (결제 안정성 및 재고 정합성 강화, 보안 리팩토링, 토스페이먼츠 마이그레이션), 결제 게이트웨이(PG) 마이그레이션 (Toss Payments Migration), 기능 추가 (Core Setup) (+13 more)
...
Cohesion: 0.19
Nodes (47): aa(), $d(), M(), N(), A(), Aa(), b(), Ba() (+39 more)

### Community 31 - "CodeMirror Code Editors"
Cohesion: 0.10
Nodes (41): A(), ae(), $b(), be(), ce(), Cf(), df(), Ef() (+33 more)

### Community 32 - "PHPExcel DateTime Calculations"
Cohesion: 0.12
Nodes (34): decodeCodepage(), includeCellRangeFiltered(), readBottomMargin(), readColInfo(), readDataValidations(), readDefColWidth(), readFooter(), readHcenter() (+26 more)

### Community 33 - "Admin Portal Functions"
Cohesion: 0.04
Nodes (4): IsNumber(), mail_send2(), MM_openBrWindow(), send_post()

### Community 34 - "Highcharts Data Visualizations"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (26): A(), Ab(), da(), F(), Fa(), Fb(), Ga(), ia() (+18 more)
...
### Community 46 - "jQuery Plugin Collection"
Cohesion: 0.12
...
### Community 50 - "PHPExcel Worksheet Management"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (4): PHPExcel_Autoloader, PHPExcel_Reader_Gnumeric, PHPExcel_Reader_OOCalc, PHPExcel_Settings

### Community 57 - "PHPExcel Excel5 Writers"
Cohesion: 0.06
Nodes (24): attach(), getCalculatedValue(), getColumn(), getCoordinate(), getDataValidation(), getFormattedValue(), getHyperlink(), getMergeRange() (+16 more)

### Community 59 - "PHPExcel Core Libraries"
Cohesion: 0.11
Nodes (18): calculateFormula(), _calculateFormulaValue(), convertMatrixReferences(), executeBinaryComparisonOperation(), executeNumericBinaryOperation(), extractCellRange(), getValueFromCache(), processTokenStack() (+10 more)

### Community 62 - "jQuery Plugin Collection"
Cohesion: 0.08
Nodes (15): ga(), ia(), ja(), oa(), pa(), qb(), ra(), s() (+7 more)

### Community 63 - "Product Category Admin"
Cohesion: 0.09
Nodes (18): check_readyToSend_order(), check_today_order(), check_unChk_order(), count_items_in_cart(), get_item_image(), get_page_num(), get_page_result(), show_brand_name() (+10 more)

### Community 64 - "PHPExcel Worksheet Management"
Cohesion: 0.07
Nodes (4): EigenvalueDecomposition, PHPExcel_Shared_JAMA_QRDecomposition, SingularValueDecomposition, hypo()

### Community 67 - "Admin Portal Functions"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (4): iframeHeight(), iframesHeight(), mfnSliderOfferThumb(), mfnSliderOfferThumb_Pager()

### Community 73 - "Admin Portal Functions"
Cohesion: 0.09
Nodes (15): a(), b$(), bD(), bF(), bi(), bm(), bZ(), ca() (+7 more)

### Community 75 - "PHPExcel Core Libraries"
Cohesion: 0.09
Nodes (3): DOMElement, DOMText, PHPExcel_Helper_HTML

### Community 76 - "PHPExcel Worksheet Management"
Cohesion: 0.07
Nodes (3): PHPExcel_Worksheet_ColumnDimension, PHPExcel_Worksheet_Dimension, PHPExcel_Worksheet_RowDimension

### Community 77 - "PHPExcel Excel2007 Writers"
Cohesion: 0.16
Nodes (10): condition(), createTree(), expression(), fact(), func(), parenthesizedExpression(), parse(), PHPExcel_Writer_Excel5_Parser (+2 more)

### Community 78 - "Admin Portal Functions"
Cohesion: 0.14
Nodes (28): addEvent(), addImage(), callAjaxForHTML5(), callFileUploader(), checkTotalImageSize(), closeWindow(), cuttingNameByLength(), delImage() (+20 more)

### Community 79 - "Admin Portal Functions"
Cohesion: 0.10
Nodes (11): checkEdit(), checkEdit2(), checkRegister(), checkRegisterP(), find_id(), find_p_id(), find_p_pw(), find_pw() (+3 more)

### Community 81 - "PHPExcel Core Libraries"
Cohesion: 0.08
Nodes (3): encodeUTF16(), PHPExcel_Shared_String, PHPExcel_Writer_Excel2007_StringTable
...
### Community 96 - "PHPExcel Worksheet Management"
Cohesion: 0.09
Nodes (4): PHPExcel_Reader_Excel2007, PHPExcel_Shared_File, PHPExcel_Shared_XMLWriter, XMLWriter
...
Cohesion: 0.10
Nodes (19): author, email, name, bugs, url, description, devDependencies, grunt (+11 more)

### Community 119 - "Admin Portal Functions"
Cohesion: 0.12
Nodes (6): coverageClass(), escapeRegexp(), HTMLCov(), image(), Mocha(), require()

### Community 123 - "Admin Portal Functions"
Cohesion: 0.13
...
Cohesion: 0.11
Nodes (23): c(), Aa(), Cd(), de(), ea(), ee(), $f(), ff() (+15 more)

### Community 125 - "CodeMirror Code Editors"
Cohesion: 0.15
Nodes (24): Ba(), G(), Hc(), hd(), hg(), Jc(), Jf(), L() (+16 more)

### Community 128 - "Admin Portal Functions"
Cohesion: 0.27
Nodes (3): Context(), Suite(), visit()

### Community 129 - "PHPExcel File Readers"
Cohesion: 0.11
Nodes (7): PHPExcel_Calculation_Exception, PHPExcel_Chart_Exception, PHPExcel_Exception, PHPExcel_Reader_Exception, PHPExcel_Writer_Exception, phpmailerException, Exception

### Community 138 - "Admin Portal Functions"
Cohesion: 0.10
Nodes (4): $Ajax(), $Json(), $S(), at()

### Community 139 - "CodeMirror Code Editors"
Cohesion: 0.17
Nodes (16): Ad(), Bd(), Gd(), hb(), ib(), Jc(), Kd(), Lc() (+8 more)

### Community 140 - "CodeMirror Code Editors"
Cohesion: 0.16
Nodes (17): c(), Aa(), Cd(), ea(), $f(), ia(), Ja(), Kb() (+9 more)
...
Cohesion: 0.08
Nodes (7): PHPExcel_Writer_Excel2007_ContentTypes, PHPExcel_Writer_Excel2007_DocProps, PHPExcel_Writer_Excel2007_Rels, PHPExcel_Writer_Excel2007_RelsRibbon, PHPExcel_Writer_Excel2007_RelsVBA, PHPExcel_Writer_Excel2007_Theme, PHPExcel_Writer_Excel2007_WriterPart

### Community 151 - "Admin Portal Functions"
Cohesion: 0.13
Nodes (5): f(), b(), c(), fontProperty(), h()

### Community 154 - "PHPExcel Core Libraries"
Cohesion: 0.08
...
Cohesion: 0.28
Nodes (5): Base(), Dot(), Landing(), NyanCat(), write()

### Community 165 - "PHPExcel Core Libraries"
Cohesion: 0.12
Nodes (15): A Simple Example, Changelog, Class Features, Contributing, Documentation, History, Installation & loading, License (+7 more)

### Community 167 - "PHPExcel Core Libraries"
Cohesion: 0.15
Nodes (5): PHPExcel_Cell_AdvancedValueBinder, PHPExcel_Cell_DataType, PHPExcel_Cell_DefaultValueBinder, setValueExplicit(), PHPExcel_Cell_IValueBinder
...
Cohesion: 0.13
Nodes (14): authors, autoload, classmap, description, license, name, require, require-dev (+6 more)

### Community 193 - "PHPExcel Worksheet Management"
Cohesion: 0.15
Nodes (5): PHPExcel_Reader_Excel5_Color_BIFF5, PHPExcel_Reader_Excel5_Color_BIFF8, PHPExcel_Reader_Excel5_Color_BuiltIn, PHPExcel_Reader_Excel5_Color, readSheetLayout()

### Community 195 - "Admin Portal Functions"
Cohesion: 0.24
Nodes (9): addHeight(), checkImage(), checkLazyImage(), dragEnd(), dragMove(), dragStart(), getTouches(), showImage() (+1 more)

### Community 196 - "Js Global Components"
Cohesion: 0.19
Nodes (5): closeWin(), MM_findObj(), MM_showHideLayers(), MM_swapImage(), setCookie()

### Community 198 - "Admin Portal Functions"
Cohesion: 0.18
...
### Community 201 - "PHPExcel Core Libraries"
Cohesion: 0.17
Nodes (6): getSplicedRecordData(), readContinue(), readImData(), readMsoDrawing(), PHPExcel_Reader_Excel5_Style_Border, PHPExcel_Reader_Excel5_Style_FillPattern

### Community 204 - "Admin Portal Functions"
Cohesion: 0.21
Nodes (5): addEndCol(), initTableWidget(), sortNumeric(), sortString(), sortTable()

### Community 206 - "Admin Portal Functions"
Cohesion: 0.22
Nodes (14): check_approved_id(), show_cart_item(), show_checkout_item(), show_item_info(), show_items_on_catalog(), show_items_on_main(), show_me_wholesale_price(), show_order_item() (+6 more)
...
### Community 225 - "Web JS Ui Jquery Ui 22 Custom Components"
Cohesion: 0.18
Nodes (5): focusable(), TODO: namespace this event, TODO: determine which cases actually cause this to happen, TODO: add this back in 1.9 and use $.error() (see #5972), visible()

### Community 226 - "PHPExcel Core Libraries"
Cohesion: 0.22
Nodes (3): HTMLFilter(), tln_sanitize(), tln_tagprint()

### Community 231 - "PHPExcel Core Libraries"
Cohesion: 0.20
...
Cohesion: 0.25
Nodes (9): createFormulaFromTokens(), getFormulaFromData(), getFormulaFromStructure(), readBIFF5CellRangeAddressFixed(), readBIFF5CellRangeAddressList(), readBIFF8CellRangeAddressList(), readDataValidation(), readFormula() (+1 more)

### Community 249 - "Admin Portal Functions"
Cohesion: 0.31
Nodes (5): Datepicker(), datepicker_bindHover(), datepicker_handleMouseover(), focusable(), visible()

### Community 254 - "Admin Portal Functions"
Cohesion: 0.54
Nodes (7): assertCanWorkWith(), exceptionalSinonMethod(), getMessages(), isCall(), isSpy(), sinonMethod(), sinonProperty()

### Community 265 - "Admin Portal Functions"
Cohesion: 0.39
Nodes (6): a(), i(), n(), r(), s(), t()

### Community 266 - "Admin Portal Functions"
Cohesion: 0.46
Nodes (6): animate(), close(), css(), initialise(), open(), toggle()

### Community 269 - "jQuery Ui Min Components"
Cohesion: 0.39
Nodes (6): a(), i(), n(), r(), s(), t()
...
### Community 307 - "jQuery Price Slider Components"
Cohesion: 0.60
Nodes (3): i(), s(), t()

### Community 311 - "Web JS Ui Jquery Ui Core Components"
Cohesion: 0.50
...
### Community 317 - "CKEditor Rich Text Editors"
Cohesion: 0.11
Nodes (3): PHPExcel_Shared_OLE_PPS_File, PHPExcel_Shared_OLE_PPS, PHPExcel_Shared_OLE_PPS_Root

### Community 321 - "PHPExcel File Readers"
Cohesion: 0.07
Nodes (8): PHPExcel_Reader_Abstract, PHPExcel_Reader_DefaultReadFilter, load(), loadIntoExisting(), PHPExcel_Reader_SYLK, lastColumnIndex, PHPExcel_Reader_IReader, PHPExcel_Reader_IReadFilter

### Community 327 - "CKEditor Rich Text Editors"
Cohesion: 0.33
Nodes (6): class.phpmailer.php:, class.smtp.php:, New examples, New /test_script, PHPDocumentator (phpdocs) documentation for PHPMailer version 5.0.0, Version 5.0.0 (April 02, 2009)

### Community 329 - "Payment Gateway APIs"
Cohesion: 0.40
Nodes (5): show_buyer_detail(), show_order_status(), get_pg_info(), show_logistics(), show_track_no()
...
### Community 354 - "Member Php Php Mailer Test Test Callb..."
Cohesion: 0.50
Nodes (3): Demo, Installation, Previous version

### Community 362 - "PHPExcel Core Libraries"
Cohesion: 0.67
Nodes (3): PATH, fakepopserver.sh script, write_log()

### Community 373 - "Admin Portal Functions"
Cohesion: 0.67
...
## Knowledge Gaps
- **243 isolated node(s):** `name`, `version`, `main`, `jquery`, `name` (+238 more)
...
- **Why does `PHPExcel_Calculation_Functions` connect `PHPExcel Formula Functions` to `PHPExcel Core Libraries`, `PHPExcel Formula Functions`, `PHPExcel Core Libraries`, `PHPExcel Excel5 Writers`, `PHPExcel Worksheet Management`, `PHPExcel Worksheet Management`, `Admin Portal Functions`, `PHPExcel Core Libraries`, `PHPExcel Excel2007 Writers`, `PHPMailer Email Utility`, `PHPExcel Worksheet Management`, `PHPExcel Core Libraries`, `PHPExcel Formula Functions`, `PHPExcel Worksheet Management`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `PHPExcel_Worksheet` connect `PHPExcel Worksheet Management` to `PHPExcel Worksheet Management`, `PHPExcel Worksheet Management`, `PHPExcel Core Libraries`, `PHPExcel Core Libraries`, `PHPExcel Core Libraries`, `PHPExcel Excel5 Writers`, `CKEditor Rich Text Editors`, `PHPExcel Core Libraries`, `PHPExcel Core Libraries`, `PHPExcel Core Libraries`, `PHPExcel Excel2007 Writers`, `PHPExcel Worksheet Management`, `Admin Portal Functions`, `Member Php Php Mailer Extras Htmlfilt...`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `PHPExcel_Shared_String` connect `PHPExcel Core Libraries` to `PHPExcel Formula Functions`, `PHPExcel DateTime Calculations`, `PHPExcel Core Libraries`, `PHPMailer Email Utility`, `PHPExcel Core Libraries`, `PHPExcel DateTime Calculations`, `PHPExcel Worksheet Management`, `PHPExcel Core Libraries`, `Payment Gateway APIs`, `PHPExcel Core Libraries`, `PHPExcel File Readers`, `PHPExcel Core Libraries`, `PHPExcel Excel5 Writers`, `PHPExcel Core Libraries`, `PHPExcel File Readers`, `PHPExcel Core Libraries`, `PHPExcel File Readers`, `PHPExcel Excel2007 Writers`, `PHPExcel File Readers`, `PHPExcel Worksheet Management`, `PHPExcel Core Libraries`?**
...
- **Are the 10 inferred relationships involving `PHPExcel_Calculation_Statistical` (e.g. with `.DAVERAGE()` and `.DCOUNT()`) actually correct?**
  _`PHPExcel_Calculation_Statistical` has 10 INFERRED edges - model-reasoned connections that need verification._
- **Are the 56 inferred relationships involving `PHPExcel_Shared_String` (e.g. with `.DATE()` and `strcmpLowercaseFirst()`) actually correct?**
  _`PHPExcel_Shared_String` has 56 INFERRED edges - model-reasoned connections that need verification._