    ...
    <div class="content">
        ...
        <div class="container">
            ...
            if($tot_amount >= $drow['min_sum'])
              $t_str .= "<strong>".number_format($last_cost2 * 1.1)."&nbsp;원 (VAT 포함)<br/>(배송비 무료)</strong>";
            else
              $t_str .= "<strong>".number_format($last_cost2 * 1.1)."&nbsp;원 (VAT 포함)<br/>(배송비: 2,500원 포함)</strong>";
        ...
        <?=$order_detail?>
              ...
              <div class="panel-heading">주문정보</div>
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9"><?=$row['orderid']?> (주문일 : <?=$row['createdate']?> )</div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">구매자( <?=$row['user_id']?> )</div>
                        <div class="col-sm-9">
                            <?=$row['buyer_name']?><br />
                            <?=$row['buyer_zipno']?> <br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9"><?=number_format($org_amount)?> + <?=number_format($org_amount*.1)?> (VAT) = <?=number_format($org_amount*1.1)?> 원</div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">처리상태</div>
                        <div class="col-sm-9"><?=$a_status[$row['status']]?></div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">배송 시 요청사항</div>
                        <div class="col-sm-9"><?=nl2br($row['memo'])?></div>
                    </div>
                    <div class="row warning">
                        <div class="col-sm-3">※ 관리자 메모</div>
                        <div class="col-sm-9"><?=nl2br($row['supplement'])?></div>
                    </div>
            ...
            <div class="row text-center">
              <a class="btn btn-primary" href="order-list.php?page=<?=$page?>">주문 목록</a>
            </div>
