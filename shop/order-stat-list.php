                ...
                <div class="panel-body text-center">
                  ...
                  <div class="row text-center">
                    <div class="form-group date-input">
                        ...
                        <input type="text" class="form-control ll-skin-nigran" name="date1" id="sd" value="" size="10" />
                    </div>
                    <div class="form-group">
                        <label for="ed"><i class="fa fa-calendar"></i>종료일 :</label>
                        <input type="text" class="form-control ll-skin-nigran" name="date2" id="ed" value="" size="10" />
                    </div>
                    <div class="form-group">
...
if ("date" == $mode) {
    $search_qry = " AND '$date1' <= DATE(createdate) AND '$date2' >= DATE(createdate) ";
    $date       = "(" . $date1 . " ~ " . $date2 . ")";
} else {
    $today      = date("Y-m-d");
