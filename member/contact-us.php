...
<?php include_once '../include/footer.php';?>
        ...
        var iwContent = '<div style="padding:5px;">소호마켓<br><a href="https://map.kakao.com/link/map/소호마켓,37.5296591, 127.1308992" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/소호마켓,37.5296591, 127.1308992" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
