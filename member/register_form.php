...
if ($mode == "edit") {
    ?>
              <form name="form1" id="form1" ENCTYPE="multipart/form-data" role="form" class="form-group" method="post" action="//<?=$_SERVER['SERVER_NAME'];?>:<?=$port;?>/member/register_ok.php">
              <input type="hidden" name="mode" value="edit">
              <input type="hidden" name="session_id" value="<?=$_SESSION["p_id"];?>">
              <input type="hidden" name="session_name" value="<?=$_SESSION["p_name"];?>">
                  ...
                  <div class="panel panel-info margin-top-10">
                    <div class="panel-heading"><h4>기본정보</h4></div>
                      <div class="panel-body">
                        ...
                        <div class="row">
                          <div class="col-sm-3 register-font">업체 아이디</div>
                          <div class="col-sm-6">
                            <div class="col-md-6">
                              <label class="sr-only" for="userid">ID</label>
                              <input class="form-control" name="userid" type="text" id="userid" value="<?=$rows['id'];?>" readonly />
                            </div>
                            <div class="col-md-6">
                              <p>(ID는 수정불가)</p>
                            </div>
                        ...
                        <div class="row">
                          <div class="col-sm-3 register-font">비밀번호</div>
                          <div class="col-sm-9">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                              <p class="help-block">정보 수정 시에는 기존 비밀번호 입력</p>
                            </div>
                          </div>
                        </div>

                        <div class="row">
                          <div class="col-sm-3 register-font">비밀번호 확인</div>
                          <div class="col-sm-6">
                            <div class="col-md-6">
                       ...
                       <div class="row">
                          <div class="col-sm-3 register-font">담당자 성명 (직함)</div>
                          <div class="col-sm-6">
                            <div class="col-md-6">
                              <label class="sr-only" for="md_name">담당자 성명</label>
                              <input class="form-control" type="text" id="md_name" name="md_name" value="<?=$rows['md_name'];?>" required />
                            </div>
                            <div class="col-md-6">
                              <label class="sr-only" for="job_title">직함</label>
                              <input class="form-control" type="text" id="job_title" name="job_title" value="<?=$rows['job_title'];?>" placeholder="직함" />
                            </div>
                          </div>
                        </div>
                       ...
                       <div class="row">
                          <div class="col-sm-3 register-font">담당자 이메일</div>
                          <div class="col-sm-6">
                            <div class="col-md-6">
                              <label class="sr-only" for="md_email">담당자 이메일</label>
                              <input class="form-control" type="email" id="md_email" name="md_email" value="<?=$rows['md_email'];?>" required />
                            </div>
                            <div class="col-md-6">
                       ...
                       <div class="row">
                          <div class="col-sm-3 register-font">담당자 휴대폰</div>
                          <div class="col-sm-6">
                            <div class="col-md-6">
                              <label class="sr-only" for="md_hphone">담당자 휴대폰</label>
                              <input class="form-control" type="text" id="md_hphone" name="md_hphone" value="<?=$rows['md_hphone'];?>" required />
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="panel-heading"><h4>비밀번호 변경</h4></div>
                      <div class="panel-body">
                        ...
                        <div class="row">
                          <div class="col-sm-3 register-font">비밀번호 변경확인</div>
                            <div class="col-sm-9">
                              <div class="col-md-6">
                                <input type="checkbox" name="changePW" value="Y" > 변경 시에만 체크
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">새 비밀번호</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                          ...
                          <div class="row">
                            <div class="col-sm-3 register-font">새 비밀번호 확인</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                    ...
                    <div class="panel panel-warning">
                      <div class="panel-heading"><h4>사업자 정보</h4> <p>(세금계산서 발행 등을 위해 사업자등록증과 동일하게 작성하시면 됩니다.)</p></div>
                        <div class="panel-body">
                          <div class="row">
                            <div class="col-sm-3 register-font">사업자 등록번호</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="license_no">사업자 등록번호</label>
                                <input class="form-control" type="text" id="license_no" name="license_no" value="<?=$rows['license_no'];?>" readonly />
                                <p class="help-block">(사업자 등록번호 수정불가)</p>
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">업체명</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="company_name">업체명</label>
                                <input class="form-control" type="text" id="company_name" name="company_name" value="<?=$rows['company_name'];?>" required />
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">대표자 성명</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="ceo">성명</label>
                                <input class="form-control" type="text" id="ceo" name="ceo" value="<?=$rows['ceo'];?>" required />
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">사업장 소재지</div>
                            <div class="col-sm-6">
                              <div class="col-md-4">
                                  <a class="btn btn-primary btn-sm" role="button" href="#" onclick="openDaumPostcode()">우편번호 검색</a>
                              ...
                              <div class="col-md-4">
                                <input class="form-control" type="text" name="o_zipcode1" id="o_zipcode1" value="<?=$o_zipno[0];?>" readonly />
                              </div>
<!--                               <div class="col-md-4">
                                <input class="form-control" type="text" name="o_zipcode2" id="o_zipcode2" value="<?=$o_zipno[1];?>" readonly />
                              </div> -->
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font"></div>
                            <div class="col-sm-9">
                              <div class="col-md-6">
                                <input class="form-control" type="text" name="o_addr1" id="o_addr1" value="<?=$rows['o_addr1'];?>" readonly="readonly" />
                              </div>
                              <div class="col-md-6">
                                <label class="sr-only" for="o_addr2">사업장 소재지</label>
                                <input class="form-control" type="text" name="o_addr2" id="o_addr2" value="<?=$rows['o_addr2'];?>" required />
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">업 태</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="category1">업태</label>
                                <input class="form-control" type="text" id="category1" name="category1" value="<?=$rows['category1'];?>" required />
                              </div>
                            </div>
                          </div>

                         <div class="row">
                            <div class="col-sm-3 register-font">종 목</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="category2">종목</label>
                                <input class="form-control" type="text" id="category2" name="category2" value="<?=$rows['category2'];?>" required />
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">과세 여부</div>
                            <div class="col-sm-6">
                              <div class="col-md-3">
                                <label class="sr-only" for="category2">과세 여부</label>
...
switch ($rows['tax_type']) {
    ...
    ?>
                                ...
                                <input type="radio" id="tax_type" name="tax_type" value="1" <?=$chk1;?> required />일반과세자
                              </div>
                              <div class="col-md-3">
                                <input type="radio" id="tax_type" name="tax_type" value="2" <?=$chk1;?> required />간이과세자
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">사업장 전화번호</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="o_phone">사업장 전화번호</label>
                                <input class="form-control" type="text" id="o_phone" name="o_phone" value="<?=$rows['o_phone'];?>" required />
                              </div>
                            </div>
                          </div>

                        <div class="row">
                            <div class="col-sm-3 register-font">사업장 팩스</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="o_fax">사업장 팩스</label>
                                <input class="form-control" type="text" id="o_fax" name="o_fax" value="<?=$rows['o_fax'];?>" />
                              </div>
                            </div>
                          </div>
                   ...
                   <div class="panel panel-warning">
                      <div class="panel-heading"><h4>배송지 정보</h4></div>
                        <div class="panel-body">
                          <div class="row">
                            <!-- <div class="col-sm-3 register-font">배송지 정보</div> -->
                            <div class="col-sm-12">
                              <!-- <div class="col-md-6"> -->
                        ...
                        <div class="row">
                            <div class="col-sm-3 register-font">배송지 주소</div>
                            <div class="col-sm-6">
                              <div class="col-md-4">
                                  <a class="btn btn-primary btn-sm" role="button" href="#" onclick="openDaumPostcode2()">우편번호 검색</a>
                              ...
                              <div class="col-md-4">
                                <input class="form-control" type="text" name="d_zipcode1" id="d_zipcode1" value="<?=$d_zipno[0];?>" readonly="readonly" />
                              </div>
                              <div class="col-md-4">
                                <input class="form-control" type="text" name="d_zipcode2" id="d_zipcode2" value="<?=$d_zipno[1];?>" readonly="readonly" />
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-9">
                              <div class="col-md-6">
                                <input class="form-control" type="text" name="d_addr1" id="d_addr1" value="<?=$rows['d_addr1'];?>" readonly="readonly" />
                              </div>
                              <div class="col-md-6">
                                <label class="sr-only" for="o_addr2">배송지 주소</label>
                                <input class="form-control" type="text" name="d_addr2" id="d_addr2" value="<?=$rows['d_addr2'];?>" required />
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">배송지 전화번호</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="d_phone">배송지 전화번호</label>
                                <input class="form-control" type="text" name="d_phone" value="<?=$rows['d_phone'];?>" required />
                              </div>
                            </div>
                          </div>

                          <div class="row">
                            <div class="col-sm-3 register-font">배송지 팩스</div>
                            <div class="col-sm-6">
                              <div class="col-md-6">
                                <label class="sr-only" for="d_fax">배송지 팩스</label>
                                <input class="form-control" type="text" name="d_fax" value="<?=$rows['d_fax'];?>" />
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12 text-center">
                        <button class="btn btn-warning" type="submit" onclick="registerConfirm()">수 정</button> <a class="btn btn-primary" role="button" href="../shop/index.php" >취 소</a>
                      </div>
                    </div>
...
Start Register Form =============================================================
 -->
              ...
              <form name="form1" id="form1" role="form" class="form-group" method="post" action="//<?=$_SERVER['SERVER_NAME'];?>:<?=$port;?>/member/register_ok.php">
              <!-- <form name="form1" id="form1" ENCTYPE="multipart/form-data" role="form" class="form-group" method="post" action="http://<?=$_SERVER['SERVER_NAME'];?>/member/register_ok.php"> -->
                  <div class="panel panel-info margin-top-10">
                    <div class="panel-heading"><h4>기본정보</h4></div>
                      <div class="panel-body">
                    ...
                    <div class="panel panel-info">
                      <div class="panel-heading"><h4>사업자 정보</h4> <p>(세금계산서 발행 등을 위해 사업자등록증과 동일하게 작성하시면 됩니다.)</p></div>
                        <div class="panel-body">
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">사업자 등록번호</div>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">업체명</div>
                            <div class="col-sm-6 col-md-3">
                              <!-- <div class="col-md-6"> -->
                                <label class="sr-only" for="company_name">업체명</label>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">대표자 성명</div>
                            <div class="col-sm-6 col-md-3">
                              <!-- <div class="col-md-6"> -->
                                <label class="sr-only" for="ceo">성명</label>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">사업장 소재지</div>
                              <div class="col-xs-6 col-md-2">
                                <input class="form-control" type="text" name="o_zipcode1" id="o_zipcode1" readonly="readonly" />
                              </div>
<!--                               <div class="col-md-4">
                                <input class="form-control" type="text" name="o_zipcode2" id="o_zipcode2" readonly="readonly" />
                              </div>
 -->
                            <div class="col-xs-6 col-md-2">
                              <!-- <div class="col-md-4"> -->
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font"></div>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">업 태</div>
                            <div class="col-xs-12 col-md-3">
                              <!-- <div class="col-md-6"> -->
                                <label class="sr-only" for="category1">업태</label>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">종 목</div>
                            <div class="col-xs-12 col-md-3">
                              <!-- <div class="col-md-6"> -->
                                <label class="sr-only" for="category2">종목</label>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">과세 여부</div>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">사업장 전화번호</div>
                            <div class="col-xs-12 col-md-3">
                              <!-- <div class="col-md-6"> -->
                                <label class="sr-only" for="o_phone">사업장 전화번호</label>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">사업장 팩스</div>
                            <div class="col-xs-12 col-md-3">
                              <!-- <div class="col-md-6"> -->
                                <label class="sr-only" for="o_fax">사업장 팩스</label>
                    ...
                    <div class="panel panel-info">
                      <div class="panel-heading"><h4>배송지 정보</h4><p>(택배 주문 시 받으실 주소)</p></div>
                        <div class="panel-body">
                         ...
                         <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">배송지 주소</div>
                              <div class="col-xs-6 col-md-2">
                                <input class="form-control" type="text" name="d_zipcode1" id="d_zipcode1" readonly="readonly" />
                              </div>
<!--                               <div class="col-md-4">
                                <input class="form-control" type="text" name="d_zipcode2" id="d_zipcode2" readonly="readonly" />
                              </div> -->
                            <div class="col-xs-6 col-md-2">
                              <!-- <div class="col-md-4"> -->
                                  <!-- <a class="btn btn-primary btn-sm" role="button" href="#" onclick="openDaumPostcode2()">우편번호 검색</a> -->
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">배송지 전화번호</div>
                          ...
                          <div class="row">
                            <div class="col-xs-12 col-md-3 register-font">배송지 팩스</div>
                            <div class="col-sm-12 col-md-3">
                              <!-- <div class="col-md-6"> -->
                                <label class="sr-only" for="d_fax">배송지 팩스</label>
