...
class XPayClient
{
     ...
     * @param boolean debug
     */
    public function XPayClient($home_dir, $mode = "real", $mid, $mertkey)
    {
        // for php4 JSON
...
//        $this->log("session id = ".session_id().$_SESSION['tx_counter'], LGD_LOG_FATAL);
    ...
    public function Gen_Auth_Code($tx_id, $MID)
    {
    ...
    public function Check_Auto_Rollback($errno)
    {
    ...
    public function set_curl_error()
    {
    ...
    public function TX($bRollbackOnError = true)
    {
        $bTX               = true;
        $bRollback         = false;
        $strRollbackReason = "";
    ...
    public function Patch_TX($filename)
    {
        $url = $this->config['aux_url'];
    ...
    public function Report($status, $msg)
    {
    ...
    public function Patch($filename)
    {
        $this->Init_TX($this->MID);
    ...
    public function Response_Names()
    {
    ...
    public function Response($name, $index = 0)
    {
        if ($this->config['output_UTF8'] == 1) {
    ...
    public function Log($msg, $level = LGD_LOG_FATAL)
    {
